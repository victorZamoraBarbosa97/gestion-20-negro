...
const GoogleLoginButton = ({ onClick, isLoading }) => (
  <button
    onClick={onClick}
    disabled={isLoading}
    className="flex items-center justify-center w-full px-4 py-3 text-base font-medium text-gray-200 bg-dark-surface border border-dark-border rounded-lg shadow-sm hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-red-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
  >
    <svg
...
const GuestLoginButton = ({ onClick, isLoading }) => (
  <button
    onClick={onClick}
    disabled={isLoading}
    className="w-full px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-dark-surface border border-dark-border rounded-lg transition-colors duration-200"
  >
...
const LoginPage = () => {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen w-full bg-dark-main p-4">
      <div className="relative w-full max-w-md">
        ...
        <div className="relative w-full p-8 space-y-6 bg-dark-surface/80 backdrop-blur-sm border border-dark-border rounded-2xl shadow-2xl">
          <Logo />
