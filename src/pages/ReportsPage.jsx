  ...
  const weeklyChartData = useMemo(() => {
    ...
    payments.forEach((payment) => {
      ...
      if (normalizedType !== "PRONÓSTICOS" && normalizedType !== "VÍA") {
        console.warn(
          `[ReportsPage] Tipo de pago desconocido o no reconocido: ${payment.type}. No se incluirá en el gráfico de barras.`
        );
        return;
      }
      ...
      if (dataMap.has(paymentWeekKey)) {
        ...
        console.warn(
          `[ReportsPage] Pago de ${payment.date.toLocaleDateString()} no cae en una semana generada para el rango actual. Clave calculada: ${paymentWeekKey}`
        );
      }
    });
